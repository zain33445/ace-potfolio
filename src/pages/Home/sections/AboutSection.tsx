...
export default function AboutSection() {
  return (
    <Section sectionId="about" className="py-24 px-6 md:px-16 border-b border-blueprint-line bg-background relative overflow-y-auto">
      <Reveal type="fadeUp">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="font-sans text-sm md:text-base text-on-surface-variant leading-relaxed font-medium">
            ...
            <div className="border-t border-b border-blueprint-line/40 py-5 my-2">
              <span className="font-mono text-[9px] text-[#FF6B00] font-bold tracking-wider block uppercase mb-1.5">[DIFFERENTIATOR_REPORT]</span>
            ...
            <div className="pt-2 space-y-4">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-3 gap-4 font-sans text-xs text-on-surface-variant">
                <li className="flex flex-col gap-1.5 bg-surface p-4 border border-blueprint-line bracket-corners">
                  <div className="flex items-center gap-2 text-primary">
                    <Check className="w-4 h-4 text-primary" />
                    <strong className="text-on-background font-bold uppercase font-space text-[11px]">Precision over Guesswork</strong>
                  </div>
                ...
                <li className="flex flex-col gap-1.5 bg-surface p-4 border border-blueprint-line bracket-corners">
                  <div className="flex items-center gap-2 text-primary">
                    <Check className="w-4 h-4 text-primary" />
                    <strong className="text-on-background font-bold uppercase font-space text-[11px]">Technological Leadership</strong>
                  </div>
                ...
                <li className="flex flex-col gap-1.5 bg-surface p-4 border border-blueprint-line bracket-corners">
                  <div className="flex items-center gap-2 text-primary">
                    <Check className="w-4 h-4 text-primary" />
                    <strong className="text-on-background font-bold uppercase font-space text-[11px]">Long-Term Partnerships</strong>
                  </div>
          ...
          <div className="lg:col-span-5 h-[400px] md:h-[480px] border border-blueprint-line bg-surface relative p-4 bracket-corners bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]">
            <div className="absolute top-4 left-4 font-mono text-[10px] text-primary font-bold z-10 block">
              [MASSING_MODEL: FLR_PLN_01]
            </div>
            <About3D />
            <div className="absolute bottom-4 left-4 font-mono text-[9px] text-on-surface-variant opacity-75 z-10 bg-background/90 px-2 py-1 border border-blueprint-line">
