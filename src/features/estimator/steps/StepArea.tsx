...
export default function StepArea({ inputs, setInputs }: { inputs: Inputs; setInputs: (updater: (prev: Inputs) => Inputs) => void }) {
  return (
    <div className="space-y-4">
      <div>
        <h4 className="font-mono text-sm text-primary tracking-widest uppercase font-bold">Step 2 of 4</h4>
        <p className="font-space text-xl text-on-background mt-1">Define the total floor area</p>
      ...
      <div className="flex justify-between items-center">
        <label className="block font-mono text-xs text-primary tracking-widest uppercase font-bold">[GRID_AREA] Total Covered Floor Area</label>
