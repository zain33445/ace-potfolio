  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="font-mono text-xs text-on-surface-variant mt-1">Verify your selections below, then transmit the design parameters to receive a full detailed proposal.</p>
      </div>
