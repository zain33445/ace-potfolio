      ...
      >
        ...
        <div className="hidden md:flex items-center gap-6 text-2xl">
          ...
          <div className="flex items-center gap-6">
            <button type="button" onClick={() => handleNav('solutions')} className="link-underline text-on-surface-variant font-mono text-base font-bold tracking-wide pb-0.5">
              SOLUTIONS
            </button>
            <button type="button" onClick={() => handleNav('about')} className="link-underline text-on-surface-variant font-mono text-base font-bold tracking-wide pb-0.5">
              ABOUT US
            </button>
            <button type="button" onClick={() => handleNav('contact')} className="link-underline text-on-surface-variant font-mono text-base font-bold tracking-wide pb-0.5">
              CONTACT US
            </button>
          </div>
          ...
          <div className="flex items-center gap-5 pr-10">
            {PAGE_LINKS.map(({ href, label }) => (
              <Link
                key={href}
                href={href}
                className={`font-mono text-base font-bold tracking-wide pb-0.5 transition-colors duration-150 ${
                  isActive(href)
                    ? 'text-primary'
