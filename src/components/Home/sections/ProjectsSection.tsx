...
export default function ProjectsSection() {
  ...
  const masonryItems = useMemo(
    () =>
      filteredProjects.map((p) => ({
        ...
        url: `/projects/${p.slug}`,
        height: isMobile
          ? Math.floor(Math.random() * 125) + 400
  ...
  return (
    ...
    >
      ...
      <Reveal type="fadeIn">
        <div className="block md:hidden px-4 mt-8 grid grid-cols-2 gap-3">
            ...
            return (
              ...
              >
                ...
                <div className="p-3 flex flex-col gap-1.5">
                    ...
                    <div className="flex flex-col gap-0.5 mt-1 text-sm tracking-wider">
                      ...
                      {project.totalAreaSqFt > 0 && (
                        <p className="font-mono text-on-surface-variant ">
                          ...
                          <span className="w-fit pl-2 text-base">
                      ...
                      {project.estimatedCost > 0 && (
                        <p className=" text-on-surface-variant ">
                          ...
                          <span
                            ...
                            className="w-fit font-bold text-lg pl-2"
                          >
                  ...
                  <div className="mt-2 self-end inline-flex items-center gap-1.5 border border-primary bg-primary px-3 py-1.5 font-mono text-[10px] font-bold uppercase tracking-wider text-white w-fit rounded-sm">
                    <span>VIEW</span>
                    <svg
            ...
            return (
              ...
              >
                ...
                <div className="relative w-full h-full overflow-hidden">
                  ...
                  >
                    <h3 className="font-[family-name:var(--font-space)] text-sm md:text-xl font-bold text-white leading-snug mb-1">
                      {project.title}
                    </h3>
                    <p className="font-mono text-xs text-white/70 mb-1 md:mb-3">
                      {project.location}
                    </p>
