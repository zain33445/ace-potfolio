        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="pt-2 space-y-4">
              <h3 className="font-space text-xl font-bold text-on-background flex items-center gap-2">
                <Compass className="w-5 h-5 text-primary" /> Our Core Values
              </h3>
              <ul className="grid grid-cols-1 sm:grid-cols-3 gap-4 font-sans text-base text-on-surface-variant">
                <li className="flex flex-col gap-1.5 bg-surface p-4 border border-blueprint-line bracket-corners">
                  <div className="flex items-center gap-2 text-primary">
                    <Check className="w-4 h-4 text-primary" />
                    <strong className="text-on-background font-bold uppercase font-space text-sm">Precision over Guesswork</strong>
                  </div>
                ...
                <li className="flex flex-col gap-1.5 bg-surface p-4 border border-blueprint-line bracket-corners">
                  <div className="flex items-center gap-2 text-primary">
                    <Check className="w-4 h-4 text-primary" />
                    <strong className="text-on-background font-bold uppercase font-space text-sm">Technological Leadership</strong>
                  </div>
                ...
                <li className="flex flex-col gap-1.5 bg-surface p-4 border border-blueprint-line bracket-corners">
                  <div className="flex items-center gap-2 text-primary">
                    <Check className="w-4 h-4 text-primary" />
                    <strong className="text-on-background font-bold uppercase font-space text-sm">Long-Term Partnerships</strong>
                  </div>
          ...
          <div className="lg:col-span-5 h-[400px] md:h-[480px] border border-blueprint-line bg-surface relative p-4 bracket-corners bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]">
            ...
            <RenderOnViewport className="w-full h-full" placeholder={<div className="w-full h-full flex items-center justify-center"><div className="font-mono text-sm text-primary animate-pulse">Loading 3D...</div></div>}>
              <About3D />
            </RenderOnViewport>
