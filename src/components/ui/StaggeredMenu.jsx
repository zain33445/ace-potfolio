...
/* Desktop: hide StaggeredMenu entirely — desktop uses horizontal nav links */
@media (min-width: 768px) {
  .sm-scope { display: none !important; }
}

/* Mobile: StaggeredMenu fills the screen, toggle sits in the top-right nav area */
@media (max-width: 767px) {
  .sm-scope { z-index: 60 !important; pointer-events: none !important; }
  .sm-scope .sm-toggle {
  ...
  .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; pointer-events: auto !important; }
