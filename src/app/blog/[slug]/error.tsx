    ...
    <section className="min-h-screen bg-background">
      <div className="mx-auto flex max-w-2xl flex-col items-center justify-center px-[var(--spacing-margin-mobile)] py-32 text-center md:px-[var(--spacing-margin-desktop)]">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <button
            onClick={reset}
            className="inline-flex items-center gap-2 border border-primary bg-primary px-8 py-3.5 font-mono text-xs font-bold uppercase tracking-wider text-white transition-all hover:bg-transparent hover:text-primary"
          >
            TRY_AGAIN
          </button>
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 border border-blueprint-line bg-transparent px-8 py-3.5 font-mono text-xs font-bold uppercase tracking-wider text-on-surface-variant transition-all hover:border-primary hover:text-primary"
          >
            BACK_TO_INSIGHTS
          </Link>
        </div>
