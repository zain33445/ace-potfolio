    ...
    <section className="min-h-screen bg-background px-[var(--spacing-margin-mobile)] py-24 md:px-[var(--spacing-margin-desktop)] md:py-32">
      ...
      {insights.length > 0 ? (
        ...
        <div className="mx-auto max-w-2xl rounded-lg border border-surface-variant bg-gray-50 p-12 text-center">
          <p className="font-[family-name:var(--font-mono)] text-xs uppercase tracking-widest text-primary/50">
            // Status: Pending
          </p>
          <h2 className="mt-4 font-[family-name:var(--font-space)] text-xl font-bold text-on-background">
            No Posts Found
          </h2>
