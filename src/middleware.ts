...
import { LEGACY_301 } from './data/legacy-redirects';
...
// Moved to src/data/legacy-redirects.ts (imported above as LEGACY_301) so
// src/data/services-cms.ts can also exclude redirect sources from internal
// link candidates without pulling this middleware module into its bundle.

// Reachable, but must never rank or be indexed.
export const NOINDEX_URLS = new Set<string>([
