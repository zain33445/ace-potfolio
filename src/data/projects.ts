 ...
 * projects.ts
 *
 * Hardcoded seed project data for the portfolio. Previously loaded from
 * extracted-projects.json (generated by `npm run extract`) but that file
 * was experimental and has been archived.
 */
